...
from flaskblog.users.utils import save_picture, send_reset_email, dict_factory
...
@users.route('/api/v1/resources/site/all', methods=['GET'])
def api_all():
...
@users.route('/api/v1/resources/site', methods=['GET'])
def api_filter():
